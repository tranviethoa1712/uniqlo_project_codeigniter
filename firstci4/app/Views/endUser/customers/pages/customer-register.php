                ...
                <div class="form-signup">
                    <div class="form-signup__note">
                        <div class="form-signup__note-left">
                            Chúng tôi sẽ gửi thư xác nhận đến địa chỉ email được liên kết với tài khoản của bạn. Hãy
                            kiểm tra email đến từ chúng tôi.
                        </div>
                    ...
                    <div class="wrapper-input">
                        ...
                        <div class="wrapper-input__right">
                            ...
                            <input value="<?= old('name') ?>" type="text" name="name" id="name-text" class="input-spe"
                    ...
                    <div class="wrapper-input">
                        ...
                        <div class="wrapper-input__right">
                            <input type="text" name="form_token" hidden value=<?php echo $form_token; ?>>
                            <input value="<?= old('email') ?>" type="text" name="email" id="email" class="input-spe"
                                placeholder="Nhập email hợp lệ" onkeyup="validateInputEmail()">
                    ...
                    <div class="wrapper-input ">
                        ...
                        <div class="wrapper-input__right">
                            <input value="<?= old('password') ?>" type="password" name="password" id="pwd"
                                class="input-spe" onkeyup="validateInputPwd()">
                            <div id="alert-pwd" class="require-note">
                                Mật khẩu cần có ít nhất 08 ký tự (bao gồm cả chữ và số). Chỉ có thể sử dụng các ký tự
                                đặc biệt này -_.@
                            </div>
                        </div>
                    </div>
                    <div class="wrapper-input ">
                        ...
                        <div class="wrapper-input__right">
                            <input value="<?= old('password_confirm') ?>" type="password" name="password_confirm"
                                id="pwd-confirm" class="input-spe" onkeyup="validateInputPwd()">
                  ...
                  <span>Hiện mật khẩu</span>
                    ...
                    <div class="policy">
                        ...
                        <div class="policy-contents">
                            ...
                            <div class="policy-contents__detail">
                                UNIQLO cam kết tôn trọng các quyền của khách hàng khi lưu trữ dữ liệu cá nhân của họ
                                trong hệ thống. Thỏa thuận bên dưới sẽ giúp khách hàng lựa chọn việc có để cho dữ liệu
                                cá nhân của mình được lưu trữ và xử lý vì mục đích cung cấp dịch vụ tương ứng. Vì mục
                                đích của thỏa thuận bên dưới, sẽ gửi “tin nhắn văn bản”, nghĩa là thông báo cung cấp
                                những thông tin quan trọng liên quan đến dịch vụ đến cho khách hàng.
                            </div>
                            <h5 class="h5">
                                <span>Đồng ý nhận quảng cáo tiếp thị (Tin nhắn không cá nhân hóa)</span>
                            </h5>
                            <div class="policy-contents__detail">
                                Tôi đồng ý cho phép Uniqlo sử dụng dữ liệu cá nhân của tôi để gửi cho tôi tin nhắn tiếp
                                thị theo dạng tin nhắn văn bản không cá nhân hóa
                            </div>
                            <div class="check-box">
                            ...
                            <div class="policy-contents__detail">
                                Tôi đồng ý cho phép Uniqlo phân tích và sử dụng dữ liệu của tôi để gửi cho tôi tin nhắn
                                tiếp thị theo dạng tin nhắn văn bản cá nhân hóa </div>
                            <div class="check-box">
                                <input type="checkbox" id="send-text" value="Hiện mật khẩu" checked>
                                <label for="send-text">
                                    <span>Tin nhắn văn bản</span>
                    ...
                    <div class="end-policy">
                        ...
                        <div class="wrapper-linkag">
                            <div><a href="#" class="text-black text-decoration-none">Điều khoản sử dụng</a></div>
                            <div><a href="#" class="text-black text-decoration-none">Chính sách bảo mật</a></div>
                        </div>
                        <div class="wrapper-loginbtn">
                            <input type="submit" name="submit" class="btn btn-dark" value="Đăng ký">
                        </div>
                    </div>
                </div>
            </div>

    ...
    ?>
            ...
            <div class="left-container">
              ...
              ?>
                            <button class="thumnail-image ">
                                <img class='dot cursor responsive' src='<?= $urlImage . $key ?>' height='100px'
                                    width='100px' onclick='currentSlide(<?= $location; ?>)'>
                            </button>
                            <?php
                  $location++;
                }
                    ...
                    <div class="overview-prd">
                        <div class="tab-head">
                            ...
                            <div class="overview-content" id="overview">
                                Tác phẩm thể hiện thiết kế về nhân vật BFF màu hồng nổi tiếng của KAWS ở mặt sau. Một
                                điểm ở mặt trước là thiết kế XX, thương hiệu của tác phẩm nghệ thuật KAWS.
                                <br>
                                <br>
                                Nhân sự kiện ra mắt ấn bản artbook mới nhất của World’s Premier of KAWS (Nhà xuất bản:
                                Phaidon), UNIQLO ra mắt bộ sưu tập UT độc quyền, lấy cảm hứng từ các tác phẩm nghệ thuật
                                nguyên bản từ artbook KAWs. Trải nghiệm sự kết hợp tiên tiến giữa sách nghệ thuật và áo
                                thun được kết hợp theo một cách mới đầy thú vị.
                                <br>
                                <br>
                                KAWS
                                <br>
                                KAWS thu hút khán giả vượt xa các bảo tàng và phòng trưng bày nơi anh thường xuyên trưng
                                bày. Trong hai thập kỷ qua, KAWS đã xây dựng một sự nghiệp thành công với những tác phẩm
                                luôn thể hiện sự nhanh nhạy của anh với tư cách là một nghệ sĩ, cũng như trí thông minh,
                                sự bất kính và tình cảm tiềm ẩn của ông đối với thời đại chúng ta. Anh ấy đã cộng tác
                                với UNIQLO, bao gồm cả việc cung cấp các thiết kế cho dự án từ thiện PEACE FOR ALL vào
                                năm 2022, đây là một thành công vang dội trên toàn thế giới.
                                <br>
                                <br>
                                © KAWS
                            </div>
                    ...
                    <div class="material-prd">
                        <div class="tab-head">
                            ...
                            <div class="overview-content" id="material">
                                ...
                                <div class="note-prd">Xin lưu ý mã số nhận diện của sản phẩm có thể có sự khác biệt, kể
                                    cả khi đó là cùng một mặt hàng.</div>
                                <div class="list-des-item">Vải</div>
                                <div class="list-des-item">100% Bông</div>
                                <div class="list-des-item">Hướng dẫn giặt</div>
                                <div class="list-des-item">Giặt máy nước lạnh, Không giặt khô, Sấy khô ở nhiệt độ thấp
                                </div>
                                <div class="note-prd-end">Xin lưu ý mã số nhận diện của sản phẩm có thể có sự khác biệt,
                                    kể cả khi đó là cùng một mặt hàng.</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="main-review__feetback">
                            ...
                            <div class="prd-feetback-container">
                                ...
                                <div class="user-fback-comment">
                                    I'm a big fan of Uniqlo's basic tees, and I was excited to see the collaboration
                                    with Kaws.

                                    The shirt is made of high-quality cotton, and it's very soft and comfortable to
                                    wear. The fit is true to size, and the shirt is long enough to stay tucked in
                                    without being too long.

                                    The design is screen printed on the back of the shirt, and it's well-done and looks
                                    great.

                                    Overall, I'm very happy with the Uniqlo Kaw's tee shirt. It's a high-quality,
                                    stylish shirt that's perfect for everyday wear. I highly recommend it to anyone
                                    who's a fan of Uniqlo or Kaws.
                                </div>
                            </div>
          ...
          ?>
            ...
            ?>
              ...
              foreach ($unitColor as $row) :
                foreach ($row as $item) {
              ?>
                            <input type="radio" name="color_prd" id="color-<?= $item['unit'] ?>"
                                class="radio-color acitve" value="<?= $item['unit'] ?>"
                                <?php if ($item['product_id'] == $id_prd) {
                                                                                                                                                  echo " checked";
                                                                                                                                                } ?> />
                            <a href="<?= base_url('user/detailProduct?idsanpham=') . $item['product_id'] ?>&sku=<?= $_GET['sku'] ?>&gioitinh=<?= $item['gender'] ?>&colorUnit=<?= $item['unit'] ?>"
                                class="color-label bg-color-<?= $item['unit'] ?>"
                                name="tab-color-<?= $item['unit'] ?>"><?= " "; ?></a>
            ...
            ?>
              ...
              ?>
                        <input type="radio" name="size_prd" id="size-<?= $unitInner; ?>" class="radio-sizing"
                            value="<?= $unitInner; ?>" />
        ...
        ?>
                <div class="btn-add-to-cart">
                    <button type="button" class="btn-submit add-product-to-cart" name="addtocart">Thêm vào giỏ
                        hàng</button>
                </div>
                <?php
          }
        ...
        <div class="contents-cards">
            ...
            <div class="row">
                <div class="styling-item">
                    <img src="<?= $urlImage ?>styleHint1.jpg" alt="styling image">
                    <div class="user-info">
                        <div class="user-img">
                            <img src="<?= $urlImage ?>styleHint_thumb1.jpg" alt="user">
                        </div>
                ...
                <div class="styling-item">
                    <img src="<?= $urlImage ?>styleHint2.jpg" alt="styling image">
                    <div class="user-info">
                        <div class="user-img">
                            <img src="<?= $urlImage ?>styleHint_thumb2.jpg" alt="user">
                        </div>
                        <div class="size-user__wrapper">
                            <div class="size-use__info-user">

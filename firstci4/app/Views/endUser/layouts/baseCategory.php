...
<html lang="en">
  ...
  />
    ...
    <link rel="stylesheet" href="<?= base_url('assets/customer/css/category.css') ?>" />
    <link rel="stylesheet" href="<?= base_url('assets/customer/css/listprd.css') ?>" />
    <link
      rel="stylesheet"
    ...
    />
    <title>QUẦN ÁO & PHỤ KIỆN DÀNH CHO NỮ</title>
  </head>
  <body>